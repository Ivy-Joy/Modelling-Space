...
if (isset($_POST['firstname'])){
	...
	$sql = "INSERT INTO `company` ( firstname, lastname, dob, email, phone, type, state, county, zip, experince, height, username, password, about, profileImage,gender, )
		VALUES('$first', '$lastname', '$dob', '$email', '$phone', '$model', '$state', '$county', '$zip', '$experience', '$height', '$username',' $password', '$dy','$filename',' $gender')";
